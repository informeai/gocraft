...
func (c *Camera) updateAngles() {
	front := mgl32.Vec3{
		internal.Cos(internal.Radian(c.rotatey)) * internal.Cos(internal.Radian(c.rotatex)),
		internal.Sin(internal.Radian(c.rotatey)),
		internal.Cos(internal.Radian(c.rotatey)) * internal.Sin(internal.Radian(c.rotatex)),
	}
